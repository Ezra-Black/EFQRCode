...
if let maxMagnification = generatorForMagnification
    ...
    maxMagnification
    generatorForMagnification.magnification = EFIntSize(width: maxMagnification, height: maxMagnification)
...
if let minMagnification = generatorForMagnification
    ...
    minMagnification
    generatorForMagnification.magnification = EFIntSize(width: minMagnification, height: minMagnification)
    generatorForMagnification.generate()
}
...
/*:
 ...
 Background color defaults to white, foreground color (for code point) defaults to black.
 */
